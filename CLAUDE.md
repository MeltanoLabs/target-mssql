...
To measure throughput, pipe a Singer file into the target and time it:

```bash
time cat target_mssql/tests/data_files/<file>.singer | uv run target-mssql --config <config.json>
```
